...
Dies besteht aus dem eigenen Hostname, der Signatur des Hostnames (durch den privaten Schlüssel des Chats signiert) und den öffentlichen Schlüssel des Schlüsselpaares (vom Chat). Das Identitätspacket wird also folgendermaßen generiert:
\begin{minted}{rust}
