...
Somit startet jeder Messenger einen HTTP-Server, welcher einen HTTP-Endpunkt anbietet (in diesem Messenger "/ws/"), um eine Websocket\footnote{%//TODO Hier richtig zitieren
