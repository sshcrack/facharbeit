...
Ein zentrales Netzwerk besteht aus einem Hauptserver, welcher Daten verarbeitet und mit welchem sich Clients verbinden können \vcite{CentralizedDefinition}. Beispiele für ein solches Netzwerk sind zum Beispiel WhatsApp oder Signal \vcite{WhatsappCentralized,SignalCentralized}. Der Client dem Zielserver "vertrauen" und kann nicht überprüfen, ob der Server von einem Hacker kompromittiert wurde \vcite{MessagingNetwork}. Dezentrale Netzwerke bestehen hingegen aus mehreren Servern, auf welche Rechenoperationen und Daten aufgeteilt werden \vcite{DecentralizedDefinition}. Ein Beispiel für das dezentrale Netzwerk ist Tor \vcite{DecentralizedTor}.
