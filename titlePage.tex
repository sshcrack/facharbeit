...
\begin{minipage}[t]{.45\linewidth}
  ...
  \hspace*{-2cm}\includegraphics[width=\linewidth]{wgm.png}
...
% Upload and include other loggo here (loggo of wikipedia is used as an example):
 \hspace*{2cm}\includegraphics[width =0.5\textwidth]{enkrypton.png} \hspace*{-1cm}
...
\node[anchor=south west, 
     ...
     {\includegraphics[width = 1.8\textwidth, height = 9cm]{bg.png}}; 
\end{tikzpicture}
\end{comment}
